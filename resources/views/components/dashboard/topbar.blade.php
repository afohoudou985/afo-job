            ...
            <div class="simplebar-content" style="padding: 0px;">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="font-size-13 text-muted">
                                <p class="mb-1">Cela ressemblera à de l’anglais simplifié.</p>
                                <p class="mb-0"><i class="mdi mdi-clock-outline"></i> <span>il y a 1 heure</span></p>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#!" class="text-reset notification-item">
                    <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                            <h6 class="mb-1">Votre commande est passée</h6>
                            <div class="font-size-13 text-muted">
                                <p class="mb-1">Si plusieurs langues fusionnent la grammaire</p>
                                <p class="mb-0"><i class="mdi mdi-clock-outline"></i> <span>il y a 3 minutes</span></p>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#!" class="text-reset notification-item">
                    <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="font-size-13 text-muted">
                                <p class="mb-1">Comme un ami sceptique de Cambridge à moi occidental.</p>
                                <p class="mb-0"><i class="mdi mdi-clock-outline"></i> <span>il y a 1 heure</span></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-2 border-top d-grid">
                        <a class="btn btn-sm btn-link font-size-14 text-center" href="javascript:void(0)">
                            <i class="mdi mdi-arrow-right-circle me-1"></i> <span>Voir Plus..</span>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="{{url('/logout')}}"><i
                            class="mdi mdi-logout font-size-16 align-middle me-1"></i> Se déconnecter</a>
                </div>
            </div>
