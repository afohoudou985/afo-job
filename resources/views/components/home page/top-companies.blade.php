        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-tittle text-center">
                    <span>ENTREPRISES EN VEDETTE</span>
                    <h2>Parcourir les meilleures entreprises</h2>
                </div>
            </div>
        </div>
        <div class="row d-flex justify-content-center" id="employerList">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="browse-btn2 text-center mt-50">
                    <a href="{{url('/jobs-page')}}" class="border-btn2">Voir toutes les offres d'emploi</a>
                </div>
            </div>
        </div>
    </div>
            ...
            .then(function (response) {
                ...
                <div class="single-services text-center mb-30">
                    ...
                    <div class="services-cap">
                        ...
                        <span>(${item['jobs'].length} offres)</span>
                    </div>
                </div>
            </div>`
