                        ...
                        <div class="logo d-flex align-items-center justify-content-center">
                            <a href="{{url('/')}}">
                                <img class="img-fluid"
                                     ...
                                     alt="Logo" style="width: 122px; height: 30px">
                            </a>
                        </div>
                    </div>
                    <!-- Menu principal -->
                            ...
                            <div class="main-menu">
                                <nav class="d-none d-lg-block">
                                    <ul id="navigation">
                                        ...
                                        <li><a href="{{url('/jobs-page')}}">Trouver un emploi</a></li>
                                        ...
                                        @if(!Auth::guard('web')->check() && !Auth::guard('admin')->check() && !Auth::guard('employer')->check())
                                            <!-- Dropdown Connexion -->
                                            <li class="dropdown">
                                                <button class="dropdown-toggle genric-btn primary head-btn1"
                                                        data-toggle="dropdown">Connexion <span class="caret"></span>
                                                </button>
                                                <ul class="submenu">
                                                    <li><a class="dropdown-item" href="{{route('admin.login')}}">Admin</a></li>
                                                    <li><a class="dropdown-item" href="{{route('employer.login')}}">Employeur</a></li>
                                                    <li><a class="dropdown-item" href="{{route('login')}}">Candidat</a></li>
                                                </ul>
                                            </li>
                                            <!-- Dropdown Inscription -->
                                            <li class="dropdown">
                                                <button class="dropdown-toggle m-lg-0 genric-btn primary-border radius head-btn2 btn-sm"
                                                        data-toggle="dropdown">Inscription <span class="caret"></span>
                                                </button>
                                                <ul class="submenu">
                                                    <li><a class="dropdown-item" href="{{route('employer.register')}}">Employeur</a></li>
                                        ...
                                        @else
                                            @auth('web')
                                                <li class="dropdown">
                                                    <button class="genric-btn primary-border head-btn2 btn-sm dropdown-toggle"
                                                            type="button" data-toggle="dropdown" aria-expanded="false">
                                                        Bonjour, {{Auth::user()->name}}
                                                    </button>
                                                    <ul class="submenu">
                                                        <li><a class="dropdown-item" href="{{route('candidate.dashboard')}}">Aller au tableau de bord</a></li>
                                            ...
                                            @auth('employer')
                                                <li class="dropdown">
                                                    <button class="genric-btn primary-border head-btn2 btn-sm dropdown-toggle"
                                                            type="button" data-toggle="dropdown" aria-expanded="false">
                                                        Bonjour, {{Auth::guard('employer')->user()->name}}
                                                    </button>
                                                    <ul class="submenu">
                                                        <li><a class="dropdown-item" href="{{route('employer.dashboard')}}">Aller au tableau de bord</a></li>
                                                        <li><a class="dropdown-item" href="{{route('employer.logout')}}">Se déconnecter</a></li>
                                                    </ul>
                                                </li>
                                            @endauth
                                            @auth('admin')
                                                <li class="dropdown">
                                                    <button class="dropdown-toggle genric-btn primary-border head-btn2 btn-sm"
                                                            type="button" data-toggle="dropdown" aria-expanded="false">
                                                        Bonjour, {{Auth::guard('admin')->user()->name}}
                                                    </button>
                                                    <ul class="submenu">
                                                        <li><a class="dropdown-item" href="{{route('admin.dashboard')}}">Aller au tableau de bord</a></li>
